---
url: "https://impeccable.style/downloads"
title: "Impeccable: The missing upgrade to Anthropic's impeccable skill"
---

[Skip to content](https://impeccable.style/downloads#main-content)
...
[01Foundation](https://impeccable.style/downloads#foundation) [02Language](https://impeccable.style/downloads#language) [03Case](https://impeccable.style/downloads#why) [04Live](https://impeccable.style/downloads#live-mode) [05Install](https://impeccable.style/downloads#downloads) [06New](https://impeccable.style/downloads#changelog) [07FAQ](https://impeccable.style/downloads#faq)
...
[Get Started](https://impeccable.style/downloads#downloads)

Works with

![Cursor](https://impeccable.style/assets/cursor-logo.png)![Claude Code](https://impeccable.style/assets/claude-logo.png)![Gemini CLI](https://impeccable.style/assets/gemini-logo.png)![Codex CLI](https://impeccable.style/assets/openai-logo.png)![VS Code Copilot](https://impeccable.style/assets/github-logo.png)![Antigravity](https://impeccable.style/assets/antigravity-logo.png)![Kiro](https://impeccable.style/assets/kiro-logo.png)![OpenCode](https://impeccable.style/assets/opencode-logo.png)![Pi](https://impeccable.style/assets/pi-logo.svg)

[v3.0.7: italic-serif hero and eyebrow-chip detection, recoverable live sessions](https://impeccable.style/downloads#changelog)
...
01 · Visualize [![Auto-generated hi-fi landing-page mock in editorial warm-paper style.](https://impeccable.style/assets/openai_image_2_hifi.jpg)](https://impeccable.style/cases/neo-mirai)02 · Shape [![Auto-generated brand toolkit: identity lockups, palette, type, icon system, and application mocks for a fictional AI design conference.](https://impeccable.style/assets/openai_image_2_brand.jpg)](https://impeccable.style/cases/neo-mirai)03 · Live build [![Finished Neo Mirai website hero and agenda, implemented from the generated conference mock.](https://impeccable.style/assets/cases/neo-mirai/live-fold.png)](https://impeccable.style/neo-mirai/)
...
[![Purple gradient UI](https://impeccable.style/antipattern-images/purple-gradients.png)Purple Gradients](https://impeccable.style/antipattern-examples/purple-gradients.html) [![Thick border accent cards](https://impeccable.style/antipattern-images/thick-border-cards.png)Side-Tab Cards](https://impeccable.style/antipattern-examples/thick-border-cards.html) [![Cards nested inside cards](https://impeccable.style/antipattern-images/cardocalypse.png)Cardocalypse](https://impeccable.style/antipattern-examples/cardocalypse.html) [![Inter font everywhere](https://impeccable.style/antipattern-images/inter-everywhere.png)Inter Everywhere](https://impeccable.style/antipattern-examples/inter-everywhere.html) [![Generic layout templates](https://impeccable.style/antipattern-images/layout-templates.png)Template Layouts](https://impeccable.style/antipattern-examples/layout-templates.html) [![Low contrast text](https://impeccable.style/antipattern-images/bad-contrast.png)Bad Contrast](https://impeccable.style/antipattern-examples/bad-contrast.html)
...
[![Screenshot of the Impeccable Chrome extension highlighting anti-patterns on a webpage](https://impeccable.style/assets/extension-detection.png)Live detection on any webpage](https://chromewebstore.google.com/detail/impeccable/bdkgmiklpdmaojlpflclinlofgjfpabf) [Install from Chrome Web Store →](https://chromewebstore.google.com/detail/impeccable/bdkgmiklpdmaojlpflclinlofgjfpabf)
