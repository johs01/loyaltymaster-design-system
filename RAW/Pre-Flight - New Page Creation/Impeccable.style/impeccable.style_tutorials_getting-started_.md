---
url: "https://impeccable.style/tutorials/getting-started/"
title: "Getting started | Impeccable"
---

[Skip to content](https://impeccable.style/tutorials/getting-started/#main)[/Impeccable](https://impeccable.style/)
...
[Docs](https://impeccable.style/docs)/ [Tutorials](https://impeccable.style/tutorials)/Getting startedTutorial

# Getting started

From zero to your first polish pass in five minutes.
...
The first question is about **register**: is this a brand surface (marketing site, landing page, portfolio, where design IS the product) or a product surface (app UI, dashboard, tools, where design SERVES the product)? Register shapes every downstream default, from type lanes to motion energy. See [brand vs product](https://impeccable.style/tutorials/brand-vs-product) for how the two diverge. Teach will form a hypothesis from your codebase and ask you to confirm, rather than starting cold.
...
- [Iterate visually with Live Mode](https://impeccable.style/tutorials/iterate-live) opens a browser picker on your dev server, generates three production-quality variants per element, and writes the accepted one back to source.
