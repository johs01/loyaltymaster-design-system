---
url: "https://impeccable.style/tutorials/iterate-live/"
title: "Iterate on UI with Live Mode | Impeccable"
---

[Skip to content](https://impeccable.style/tutorials/iterate-live/#main)[/Impeccable](https://impeccable.style/)
...
[Docs](https://impeccable.style/docs)/ [Tutorials](https://impeccable.style/tutorials)/Iterate on UI with Live ModeTutorial

# Iterate on UI with Live Mode

Pick an element, generate three variants, accept one. Canvas-like iteration without leaving your code.
...
- Impeccable installed (see [getting started](https://impeccable.style/tutorials/getting-started) if you have not). Run `/impeccable teach` first if you haven’t yet: variants lean on `PRODUCT.md` and `DESIGN.md` for brand fit.
...
A monthly letter, for people who still read email.
...
- Pair with [critique with the overlay](https://impeccable.style/tutorials/critique-with-overlay): run critique first, fix priority issues, then use live to explore redirections on the element critique flagged.
