---
url: "https://impeccable.style/tutorials/critique-with-overlay/"
title: "Critique with the visual overlay | Impeccable"
---

[Skip to content](https://impeccable.style/tutorials/critique-with-overlay/#main)[/Impeccable](https://impeccable.style/)
...
[Docs](https://impeccable.style/docs)/ [Tutorials](https://impeccable.style/tutorials)/Critique with the visual overlayTutorial

# Critique with the visual overlay

Use /impeccable critique plus the browser overlay to review a live page with ground truth.
...
- Impeccable installed in your project (see [getting started](https://impeccable.style/tutorials/getting-started) if you have not).
...
- [Iterate on the critique findings with Live Mode](https://impeccable.style/tutorials/iterate-live). Pick the element critique flagged, drop a comment, get three redirections hot-swapped in place, and write the accepted one back to source.
