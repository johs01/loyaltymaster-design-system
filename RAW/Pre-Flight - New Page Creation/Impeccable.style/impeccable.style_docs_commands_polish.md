---
url: "https://impeccable.style/docs/commands/polish"
title: "Impeccable: The missing upgrade to Anthropic's impeccable skill"
---

[Skip to content](https://impeccable.style/docs/commands/polish#main-content)
...
[01Foundation](https://impeccable.style/docs/commands/polish#foundation) [02Language](https://impeccable.style/docs/commands/polish#language) [03Case](https://impeccable.style/docs/commands/polish#why) [04Live](https://impeccable.style/docs/commands/polish#live-mode) [05Install](https://impeccable.style/docs/commands/polish#downloads) [06New](https://impeccable.style/docs/commands/polish#changelog) [07FAQ](https://impeccable.style/docs/commands/polish#faq)
...
[Get Started](https://impeccable.style/docs/commands/polish#downloads)

Works with

![Cursor](https://impeccable.style/docs/commands/assets/cursor-logo.png)![Claude Code](https://impeccable.style/docs/commands/assets/claude-logo.png)![Gemini CLI](https://impeccable.style/docs/commands/assets/gemini-logo.png)![Codex CLI](https://impeccable.style/docs/commands/assets/openai-logo.png)![VS Code Copilot](https://impeccable.style/docs/commands/assets/github-logo.png)![Antigravity](https://impeccable.style/docs/commands/assets/antigravity-logo.png)![Kiro](https://impeccable.style/docs/commands/assets/kiro-logo.png)![OpenCode](https://impeccable.style/docs/commands/assets/opencode-logo.png)![Pi](https://impeccable.style/docs/commands/assets/pi-logo.svg)

[v3.0.7: italic-serif hero and eyebrow-chip detection, recoverable live sessions](https://impeccable.style/docs/commands/polish#changelog)
...
01 · Visualize [![Auto-generated hi-fi landing-page mock in editorial warm-paper style.](https://impeccable.style/docs/commands/assets/openai_image_2_hifi.jpg)](https://impeccable.style/cases/neo-mirai)02 · Shape [![Auto-generated brand toolkit: identity lockups, palette, type, icon system, and application mocks for a fictional AI design conference.](https://impeccable.style/docs/commands/assets/openai_image_2_brand.jpg)](https://impeccable.style/cases/neo-mirai)03 · Live build [![Finished Neo Mirai website hero and agenda, implemented from the generated conference mock.](https://impeccable.style/docs/commands/assets/cases/neo-mirai/live-fold.png)](https://impeccable.style/neo-mirai/)
...
[![Purple gradient UI](https://impeccable.style/docs/commands/antipattern-images/purple-gradients.png)Purple Gradients](https://impeccable.style/antipattern-examples/purple-gradients.html) [![Thick border accent cards](https://impeccable.style/docs/commands/antipattern-images/thick-border-cards.png)Side-Tab Cards](https://impeccable.style/antipattern-examples/thick-border-cards.html) [![Cards nested inside cards](https://impeccable.style/docs/commands/antipattern-images/cardocalypse.png)Cardocalypse](https://impeccable.style/antipattern-examples/cardocalypse.html) [![Inter font everywhere](https://impeccable.style/docs/commands/antipattern-images/inter-everywhere.png)Inter Everywhere](https://impeccable.style/antipattern-examples/inter-everywhere.html) [![Generic layout templates](https://impeccable.style/docs/commands/antipattern-images/layout-templates.png)Template Layouts](https://impeccable.style/antipattern-examples/layout-templates.html) [![Low contrast text](https://impeccable.style/docs/commands/antipattern-images/bad-contrast.png)Bad Contrast](https://impeccable.style/antipattern-examples/bad-contrast.html)
...
[![Screenshot of the Impeccable Chrome extension highlighting anti-patterns on a webpage](https://impeccable.style/docs/commands/assets/extension-detection.png)Live detection on any webpage](https://chromewebstore.google.com/detail/impeccable/bdkgmiklpdmaojlpflclinlofgjfpabf) [Install from Chrome Web Store →](https://chromewebstore.google.com/detail/impeccable/bdkgmiklpdmaojlpflclinlofgjfpabf)
