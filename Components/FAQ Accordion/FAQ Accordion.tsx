...
export const FAQAccordion = () => {
  const [openIndex, setOpenIndex] = useState<number | null>(1); // Default second item open to match HTML reference
  ...
  return <section className="relative w-full bg-white py-[84px]">
      <div className="mx-auto w-full max-w-[840px] px-6 md:px-12">
        ...
        ease: [0.22, 1, 0.36, 1]
          ...
          <h2 className="m-0 text-4xl font-bold leading-[1.05] tracking-[-0.2px] text-[#302127] md:text-[52px]">
