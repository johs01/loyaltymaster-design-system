      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12">
        ...
        margin: "-100px"
          ...
          <motion.div variants={itemVariants} className="flex flex-col max-w-xl">
            <p className="text-[#979093] text-sm md:text-base font-bold uppercase tracking-wide mb-3 md:mb-4">
              Use case 02
            </p>
            
            <h2 className="text-3xl md:text-[36px] leading-[1.1] font-bold text-[#302127] mb-4 tracking-[-0.2px]">
              Capture Nearby Customers with Geo-Fenced Messaging
            </h2>
            
            <p className="text-lg md:text-[20px] leading-[1.5] text-[#302127] mb-6 md:mb-8 tracking-[-0.4px]">
            ...
            <ul className="flex flex-col gap-4 mb-8 md:mb-10">
              <li className="flex items-start gap-3 text-lg md:text-[20px] leading-[1.3] text-[#302127] tracking-[-0.4px]">
                <CheckSquareIcon />
          ...
          <motion.div variants={itemVariants} className="relative w-full max-w-[568px] mx-auto lg:ml-auto">
            <div className="relative aspect-square w-full rounded-[20px] border border-[#979093]/20 bg-[#f8fafc] overflow-hidden flex items-center justify-center shadow-sm">
              <img src="https://ik.imagekit.io/loyalty/sendpush/image%20placeholder-640-square.jpg?tr=w-800,q-85:w-1080,c-at_max" alt="Geo-fence visual placeholder" className="w-full h-full object-cover" loading="lazy" />
