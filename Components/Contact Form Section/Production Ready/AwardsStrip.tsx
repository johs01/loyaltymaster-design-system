  ...
  return <section className={`w-full overflow-hidden pt-16 pb-14 ${className}`} style={{
    backgroundColor
      ...
      <div className="mx-auto w-full max-w-[1280px] px-6 md:px-12">
        <div className="flex flex-wrap items-center justify-center gap-8 order-last md:order-none">
          ...
          delay: index * 0.15,
          ease: easing
        }} className="flex min-w-[280px] flex-1 basis-0 items-center justify-center" style={{
