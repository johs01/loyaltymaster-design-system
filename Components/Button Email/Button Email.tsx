      ...
      <div className="mx-auto w-full max-w-[1280px] px-6 md:px-12">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[583px_minmax(0,1fr)] lg:gap-12">
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate="show" className="flex flex-col">
            <motion.p variants={fadeUpVariant} className="mb-4 text-sm font-bold uppercase tracking-wide text-[#979093]" style={{
            display: "none"
          }}>
              Customer messaging system
            </motion.p>
            
            <motion.h1 variants={fadeUpVariant} className="mb-6 max-w-[760px] text-5xl font-bold leading-[1.05] tracking-tight text-[#302127] md:text-6xl lg:text-[72px]" style={{
            display: "none"
          }}>
              Have Your Own Customer List. Message Them Anytime - Free.
            </motion.h1>
            
            <motion.p variants={fadeUpVariant} className="mb-8 max-w-[640px] text-lg leading-relaxed tracking-tight text-[#302127]/90 md:text-[20px]" style={{
            display: "none"
          }}>
            ...
            <motion.ul variants={fadeUpVariant} className="mb-10 flex flex-col gap-4">
              {CHECKLIST_ITEMS.map((item, index) => <li key={index} className="flex items-start gap-3 text-lg tracking-tight text-[#302127] md:text-[20px]" style={{
              display: "none"
            }}>
          ...
          <motion.div initial="hidden" animate="show" variants={imageVariant} className="relative mx-auto w-full max-w-[553px] lg:ml-auto lg:mr-0">
            <div className="relative flex aspect-square w-full items-center justify-center overflow-hidden rounded-[20px] border border-[#979093]/20 bg-white/40 shadow-xl backdrop-blur-sm transition-transform duration-500 hover:scale-[1.02]" style={{
            display: "none"
          }}>
              <div className="absolute inset-0 bg-gradient-to-tr from-white/10 to-transparent" style={{
              display: "none"
            }} />
              <img src="https://ik.imagekit.io/loyalty/sendpush/Image02.png?tr=w-800,q-85:w-3840,c-at_max" alt="Customer messaging platform dashboard" className="h-full w-full object-contain p-2" loading="eager" style={{
              display: "none"
            }} />
            </div>
          </motion.div>
